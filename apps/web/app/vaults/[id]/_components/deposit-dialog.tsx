...
export function DepositDialog({ vaultAddress, asset }: DepositDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button icon={CoinsIcon}>Deposit</Button>
      </DialogTrigger>
      <DialogContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              Deposit assets into this yield redirector vault. Your principal
              will be preserved and you can withdraw anytime. All yield will be
              directed to the connected strategy.
            </DialogDescription>
          </DialogHeader>
